...
// Skip attributes
assert.strictEqual(
	smartify('<a title="This is a \'test\'">Link</a>'),
	'<a title="This is a \'test\'">Link</a>'
)

// Complex paragraph (shortened)
assert.ok(
	smartify('As the scornful cry "So what?" echoes')
		.includes('“So what?”')
)
...
assert.strictEqual(
	smartify(smartifyTest4),
	'First issue of companion newletter to <a href="/magazines/electronic-games/">Electronic Games</a> magazine, meant to deliver news faster than normal magazine lead–time allowed. Topics include the introduction of the Emerson Arcadia 2001, new games and add–ons for the Atari 2600, the launch of ColecoVision and plenty for news bites. Reviews include Space Jockey and Gangster Alley for the Atari 2600, Star Strike for Intellivision and more.')

console.log('smartify tests passed')
